            ...
            {['Get', 'In', 'Touch'].map((word, index) => (
              <motion.span
                ...
                animate={isInView ? { 
                  opacity: [0, 1, 1],
                  color: index === 0 
                    ? ['#00B2E3', '#00B2E3', '#ffffff']  // "Get": blue to white
                    : index === 1
                    ? ['#ffffff', '#ffffff', '#00B2E3']  // "In": white to blue
                    : ['#00B2E3', '#00B2E3', '#ffffff']  // "Touch": blue to white
              ...
              <div className="space-y-6">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-foreground">+63 915 942 5146</p>
                    <p className="text-foreground">+968 7624 6978</p>
                  </div>
                </div>
